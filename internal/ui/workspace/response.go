...
func (v *ResponseViewer) spansForChunk(chunkStart, chunkEnd int, sp theme.SyntaxPalette, bracketCycle bool) []widgets.ColoredSpan {
...
func (v *ResponseViewer) Bytes() []byte { return v.text }
