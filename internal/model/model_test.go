...
func TestDefaultSettings_Values(t *testing.T) {
	...
	checks := []struct {
		...
		{"RequestTimeoutSec", s.RequestTimeoutSec, 30},
		{"ConnectTimeoutSec", s.ConnectTimeoutSec, 10},
		{"TLSHandshakeTimeoutSec", s.TLSHandshakeTimeoutSec, 10},
		{"IdleConnTimeoutSec", s.IdleConnTimeoutSec, 90},
