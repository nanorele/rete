...
func menuOptionCompactStyled(gtx layout.Context, th *material.Theme, clk *widget.Clickable, title string, icon *widget.Icon, iconCol color.NRGBA, textCol color.NRGBA, bold bool) layout.Dimensions {
...
func MenuOptionCompact(gtx layout.Context, th *material.Theme, clk *widget.Clickable, title string, icon *widget.Icon) layout.Dimensions {
	return menuOptionCompactStyled(gtx, th, clk, title, icon, th.Fg, th.Fg, false)
}

func MenuOptionDangerCompact(gtx layout.Context, th *material.Theme, clk *widget.Clickable, title string, icon *widget.Icon) layout.Dimensions {
	return menuOptionCompactStyled(gtx, th, clk, title, icon, theme.Danger, theme.Danger, true)
}
